...
SdlInputHandler::SdlInputHandler(StreamingPreferences& prefs, int streamWidth, int streamHeight)
    : m_MultiController(prefs.multiController),
      ...
      m_RazerVirtualDisplayMode(prefs.razerVirtualDisplayMode),
      ...
      m_NumFingersDown(0)
{
    ...
    m_SpecialKeyCombos[KeyComboToggleStatsOverlayLite].keyCombo = KeyComboToggleStatsOverlayLite;
    m_SpecialKeyCombos[KeyComboToggleStatsOverlayLite].keyCode = SDLK_a;
    m_SpecialKeyCombos[KeyComboToggleStatsOverlayLite].scanCode = SDL_SCANCODE_A;
    m_SpecialKeyCombos[KeyComboToggleStatsOverlayLite].enabled = true;
